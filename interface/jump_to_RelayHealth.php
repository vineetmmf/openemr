...
if( $GLOBALS['rh_api'] && $_SESSION['rh_api_id'] != "" )
{
    ...
    switch( trim($_REQUEST['dest']) )
    {
      ...
      case "escripts":
        ...
        $pub = sqlStatement("SELECT pubpid FROM patient_data WHERE pid = ?", array($pid) );
      ...
      default:
        ...
        echo htmlspecialchars( xl('Relay Health credentials are missing from this user account.'), ENT_NOQUOTES);
        die;
}
?>
