...
if( $GLOBALS['rh']['rh_api'] && $_SESSION['rh']['rh_api_id'] != "" )
{
    $rhid = trim($_SESSION['rh']['rh_api_id']);
    $mrn = trim($_SESSION['rh']['rh_mrn']);
    $aaid = trim($GLOBALS['rh']['rh_api_aaid']);
    $wsdl = trim($GLOBALS['rh']['ssi']['wsdl']);
    $location = trim($GLOBALS['rh']['ssi']['location']);
    $partner = trim($GLOBALS['rh']['ssi']['PartnerName']);
    $appname = trim($GLOBALS['rh']['ssi']['ApplicationName']);
    $apppass = trim($GLOBALS['rh']['ssi']['ApplicationPassword']);
