...
if( $GLOBALS['rh']['rh_api'] ) {
    ...
    $wsdl = trim($GLOBALS['rh']['message']['wsdl']);
    $location = trim($GLOBALS['rh']['message']['location']);
    $partner = trim($GLOBALS['rh']['message']['PartnerName']);
    $appname = trim($GLOBALS['rh']['message']['ApplicationName']);
    $apppass = trim($GLOBALS['rh']['message']['ApplicationPassword']);
