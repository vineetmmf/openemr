 ...
 * <?php
 ...
 <script type="text/javascript" src="<?php echo $web_root ?>/library/js/jquery.autocomplete.js"></script>
 <script type="text/javascript" src="<?php echo $rootdir ?>/forms/body/scripts/ajax_search.js"></script>
 <link rel="stylesheet" type="text/css" href="<?php echo $web_root ?>/library/js/jquery.autocomplete.css" />
 ...
 <b>Dx: </b><input type="text" id="diagnostic" name="diagnostic" alt="Search Criteria" onkeyup="searchSuggest('<?php echo $rootdir ?>');" autocomplete="off" />
