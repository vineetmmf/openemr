...
<form method=post action="<?echo $rootdir;?>/forms/physical_sample/save.php?mode=new" name="physical_sample" onsubmit="return top.restoreSession()">
<hr>
<h1> <? xl("physical_sample",'e') ?> </h1>
<hr>
