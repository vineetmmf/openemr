...
<div class="rule_detail">
    ...
    <div class="section text">
        <p class="header"><?php echo out( xl( 'Clinical targets' ) ); ?> <a href="index.php?action=edit!add_criteria&id=<?php echo out( $rule->id ); ?>&criteriaType=target" class="action_link">(<?php echo out( xl( 'add' ) ); ?>)</a></p>
        <p>
    ...
    <!-- rule actions -->
    <!--              -->
    <?php $actions = $rule->actions; if ( $actions && $targets->criteria) { ?>
    <div class="section text">
        <p class="header"><?php echo out( xl( 'Actions' ) ); ?>
            <a href="index.php?action=edit!add_action&id=<?php echo out( $rule->id ); ?>" class="action_link">
                (<?php echo out( xl( 'add' ) ); ?>)
            </a>
        </p>
        <p>
