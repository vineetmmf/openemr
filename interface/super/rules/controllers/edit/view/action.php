...
<div class="rule_detail edit text">
    ...
    <!-- custom rules input -->
    <p class="row">
        <span class="left_col colhead req" data-field="fld_target"><?php echo out( xl( 'For target' ) ); ?></span>
        <span class="end_col">
            <select data-grp-tgt="" type="dropdown" name="fld_target" id="">
                ...
                <option id="<?php echo out( $criteria->guid ); ?>" 
                        value="<?php echo out( $criteria->guid ); ?>"
                        <?php echo $action->targetCriteria->guid == $criteria->guid ? "SELECTED" : "" ?>>
                        <?php echo out( $criteria->getTitle() ); ?>
                </option>
                <?php } ?>
            </select>
        </span>
