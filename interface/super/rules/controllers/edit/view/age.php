...
<!-- age unit -->
<p class="row">
    <span class="left_col colhead req" data-fld="fld_timeunit"><?php echo xl('Unit');?></span>
    <span class="end_col">
    <?php echo timeunit_select( array( "target"=>"fld_timeunit", "name" => "fld_timeunit", "value" => out( $criteria->timeUnit ) ) ); ?>
    </span>
</p>
