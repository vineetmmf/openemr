...
<div class="rule_detail edit text">
    ...
    <?php foreach ( $allowed as $type ) { ?>
        <li>
        <a href="index.php?action=edit!choose_criteria&id=<?php echo out( $ruleId ); ?>&type=<?php echo out( $viewBean->type ); ?>&criteriaType=<?php echo out( $type->code ); ?>"><?php echo out( xl( $type->lbl ) ); ?></a>
        </li>
    <?php } ?>
    </ul>
</div>