...
function surgery_notes_report( $pid, $encounter, $cols, $id) {
    $count = 0;
...
$field_names = array('operation_date' => 'date','present_date' => 'date','patient_name' => 'textfield','reg_number' => 'textfield','provider_name' => 'provider','surg_incision' => 'textarea');
